...
interface JobLandingWithDataProps {
  initialJobs: Job[];
...
export function JobLandingWithData({ initialJobs, serverError, onAdminClick }: JobLandingWithDataProps) {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa]">
      <div className="max-w-6xl mx-auto px-6 py-24">
        ...
        {activeJobs.length === 0 && !serverError && (
