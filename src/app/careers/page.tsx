...
export default function CareersPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] relative overflow-hidden">
      {/* Hero Section */}
      <div className="bg-black text-white relative overflow-hidden py-10 md:py-16 min-h-[30vh] md:min-h-[40vh] flex items-center">
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap items-center gap-8">
              <div className="flex flex-col">
                ...
                <span className="text-xs font-black uppercase tracking-widest text-gray-500 mt-1">Clients Served</span>
              </div>
              <div className="w-px h-12 bg-gray-800" />
              <div className="flex flex-col">
                <span className="text-4xl font-black text-white">3</span>
                <span className="text-xs font-black uppercase tracking-widest text-gray-500 mt-1">Markets (IN, EU, USA)</span>
              </div>
              <div className="w-px h-12 bg-gray-800" />
              <div className="flex flex-col">
                <span className="text-4xl font-black text-white">72hrs</span>
                <span className="text-xs font-black uppercase tracking-widest text-gray-500 mt-1">Avg placement</span>
              </div>
              <div className="w-px h-12 bg-gray-800" />
              <div className="flex flex-col">
                <span className="text-4xl font-black text-white">
                  {loading ? <Skeleton className="h-10 w-12 bg-gray-800" /> : jobs.length}
                </span>
